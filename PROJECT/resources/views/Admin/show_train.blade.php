...
<div class="container mt-4">
    ...
    <div class="row">
        @foreach ($trains as $train)
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('create_schedule', ['train_id' => $train->id]) }}" class="btn btn-success btn-sm"
                            ...
                            <div class="dropdown">
                                <button class="btn btn-secondary btn-sm dropdown-toggle" type="button" id="actionDropdown{{ $train->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                                    Action
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="actionDropdown{{ $train->id }}">
                                    <li><a class="dropdown-item text-warning" href="#" data-bs-toggle="modal" data-bs-target="#editModal{{ $train->id }}">Edit</a></li>
                                    <li><a class="dropdown-item text-danger" href="#" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $train->id }}">Delete</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('update_train', $train->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $train->name }}" required>
                                </div>
                            </div>
            ...
            <!-- Delete Modal -->
            <div class="modal fade" id="deleteModal{{ $train->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $train->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
