                    ...
                    <div class="card border-0 shadow-sm py-3 px-4">
                        <div class="text-center py-2 mb-3">
                            <div class="register-header">
                                <img src="{{ asset('images/verify.svg') }}" class="img-fluid" alt="Promotional Image">  
                        ...
                        <form class="row gy-3" action="{{url('register')}}" method="post">
                            ...
                            <div class="col-12">
                                <label for="dobInp" class="form-label">Date of Birth</label>
                                <input type="date" class="form-control" id="dobInp" name="date_of_birth"
                            ...
                            <div class="col-12">
                                <label for="confirmPassInp" class="form-label">Confirm Password</label>
                                <input type="password" class="form-control" id="confirmPassInp" name="password_confirmation">
